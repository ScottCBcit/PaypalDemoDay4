...
using static WebSecurityDay3.Services.ReCAPTCHA;

namespace WebSecurityDay3.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                MyRegisteredUserRepo myRegisteredUserRepo = new(_context);
                myRegisteredUserRepo.CreateUser(Input.FirstName, Input.LastName, Input.Email);
